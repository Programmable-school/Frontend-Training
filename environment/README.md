...
バージョン管理システムにはnpmとyarnがあります。<br>
npm又はyarnでパッケージをインストールするとnode_modulesフォルダとpackage.jsonが生成されます。<br>

・node_modules<br>
インストールしたパッケージが保存されているフォルダです。インストールしたパッケージのソースコードを確認できます。<br>
